...
namespace Hook
{
    ...
    void AutoMoveHandler::Hook()
    {
        ...
        FnPB = stl::unrestricted_cast<FnProcessButton>(vtable.write_vfunc(5, &AutoMoveHandler::ProcessButton));
    }
    ...
    void AttackBlockHandler::Hook()
    {
        ...
        fnCP.insert(std::pair<uintptr_t, FnCanProcess>(
            vtable.address(), stl::unrestricted_cast<FnCanProcess>(vtable.write_vfunc(1, &AttackBlockHandler::CanProcess))));
        fnPB_D.insert(std::pair<uintptr_t, FnProcessButton_Data>(
            vtable.address(), stl::unrestricted_cast<FnProcessButton_Data>(vtable.write_vfunc(4, &AttackBlockHandler::ProcessButton))));
    }*/
